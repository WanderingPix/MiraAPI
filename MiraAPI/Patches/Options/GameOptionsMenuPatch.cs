...
public static class GameOptionsMenuPatch
{
    ...
    public static void UpdatePatch(GameOptionsMenu __instance)
    {
        ...
        var filteredGroups =
            GameSettingMenuPatches.SelectedMod?.OptionGroups.Where(
                x => x.AdvancedRole is null && (x.AdvancedMode is null || x.AdvancedMode == CustomGameModeManager.ActiveMode?.GetType())) ?? [];
    ...
    public static bool SettingsPatch(GameOptionsMenu __instance)
    {
        ...
        var filteredGroups = GameSettingMenuPatches.SelectedMod?.OptionGroups.Where(x => x.AdvancedRole is null && (x.AdvancedMode is null || x.AdvancedMode ==
